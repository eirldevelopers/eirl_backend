  ...
  <nav class="ei-nav container-fulid navbar navbar-expand-md fixed-top">
    <div class="ei-nav-container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="ei-nav-options navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'index' ? 'active' : '' ?>" aria-current="page" href="<?php echo base_url('home') ?>">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'load_about' ? 'active' : '' ?>" href="<?php echo base_url('about') ?>">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'load_what_we_do' ? 'active' : '' ?>" href="<?php echo base_url('what_we_do') ?>">What we do</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'load_work_with_us' ? 'active' : '' ?>" href="<?php echo base_url('work_with_us') ?>">Work With Us</a>
          </li>
          <li class="nav-item">
  ...
  <nav class="nav-other container-fulid navbar navbar-expand-md fixed-top">
    <div class="ei-nav-container container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="ei-nav-options navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'load_index' ? 'active' : '' ?>" aria-current="page" href="<?php echo base_url('home') ?>">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $this->router->fetch_method() == 'load_about' ? 'active' : '' ?>" href="<?php echo base_url('about') ?>">About</a>
          </li>
